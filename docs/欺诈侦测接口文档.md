...
```json 
{
    "businessSceneId": "xxx",       // Required; 业务场景id，需要找客户经理配置
...
Url:                `http://dataapp.tendcloud.com/api/sdk/v1/risk/detect`  
Http method： `POST`  
Post Body: 
...
```json 
{
    ...
    "eventType": 1,                 // 1="申请",2="激活",3="登录",4="支付",5="注册"
    "platformId": 1,                // 1="Android",2="iOS",3="WindowsPhone",4="HTML5"
    "features": {                   // SDK客户端输入的特征
        "csp": {"k":"v"},           // csp特征.需要服务端进一步加工形成最终的特征. 格式JsonObject
        "bio": [                    // 行为生物识别特征
            0.0, 
            0.01, 
            0.34,
...
### 侦测欺诈请求，并返回详情（SDK）
Url:                `http://dataapp.tendcloud.com/api/sdk/v1/risk/detect/detail`  
Http Method: `POST `   
Post Body:   
